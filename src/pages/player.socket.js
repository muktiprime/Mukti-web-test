  ...
  useEffect(() => {
    ...
    ws.onopen = (event) => {
      ...
      let data = {
        ...
        secret: macaddress,
        plan: plan.plan.id ? plan.plan.id : "",
        // "plan": 1,
        data: {
          video: videoInfo.title ? videoInfo.title : "slug",
          plan: plan.plan.id ? plan.plan.id : "default 1",
          source: "website",
        },
      };
    ...
    ws.onmessage = (event) => {
      ...
      // setChecking(false)
      // setLoading(false);
      // return <DeviceRestriction navigation={navigation} />
      // }
      // setTimeout(() => {
      // setLoading(false)
      // }, 1000)
